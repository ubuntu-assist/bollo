...
import expertSliderImage1 from '../../assets/images/expert_slider_img_1.png'
import expertSliderImage2 from '../../assets/images/expert_slider_img_2.png'
import expertSliderImage3 from '../../assets/images/expert_slider_img_3.png'
                ...
                <div className='flex items-center gap-3'>
                  ...
                  <div className='relative'>
                    ...
                    <div className='absolute bottom-3 right-1 z-30'>
                      <img src={verifyBadge} alt='Verified' />
                    </div>
                  </div>
