import safeGuardSectionImg from '../../assets/images/safe_guard_section_img.png'
import safeGuardReviewImg from '../../assets/images/safe_guard_review_img.png'
