import ctaImg1 from '../../assets/images/cta_img1.png'
import ctaImg2 from '../../assets/images/cta_img2.png'
          ...
          <div className='stp-15 flex flex-wrap items-center justify-start gap-6'>
            <div className='flex items-center justify-start'>
              <div className='overflow-hidden rounded-full bg-[#1B3B86] p-1'>
                <img src={ctaImg1} alt='User avatar' className='rounded-full' />
              </div>
              <div className='-ml-5 overflow-hidden rounded-full bg-[#1B3B86] p-1'>
                <img src={ctaImg2} alt='User avatar' className='rounded-full' />
              </div>
              <div className='-ml-5 overflow-hidden rounded-full bg-[#1B3B86] p-1'>
