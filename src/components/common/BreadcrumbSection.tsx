...
import expertImg1 from '../../assets/images/expert_img_1.png'
import expertImg2 from '../../assets/images/expert_img_2.png'
import expertImg3 from '../../assets/images/expert_img_3.png'
        ...
        <div className='flex items-center justify-between pt-10 max-md:gap-6 max-sm:flex-col'>
          ...
          <div className='rounded-xl border border-[#1B3B86]/10 bg-white p-6 shadow-sm'>
            ...
            <div className='flex items-center justify-start'>
              {[expertImg1, expertImg2, expertImg3].map((img, index) => (
                <div
                  key={index}
                  className={`${
                    index !== 0 ? '-ml-4' : ''
