...
import heroSliderImg1 from '../../assets/images/hero_slider_img_1.png'
import heroSliderImg2 from '../../assets/images/hero_slider_img_2.png'
import heroSliderImg3 from '../../assets/images/hero_slider_img_3.png'
import heroSliderImg4 from '../../assets/images/hero_slider_img_4.png'
          ...
          <div className='relative'>
            ...
            <div className='absolute -bottom-2 right-2 flex items-center justify-start rounded-full border border-[#1B3B86]/20 p-1 max-[450px]:hidden sm:bottom-0 sm:right-12 md:right-32 lg:right-20 xl:bottom-2 xl:right-28 xxl:right-44'>
              ...
              <div className='-ml-2 max-lg:size-8 lg:-ml-4'>
                <img src={peoplePlus} alt='' className='rounded-full' />
              </div>
            </div>
          </div>
        </div>
